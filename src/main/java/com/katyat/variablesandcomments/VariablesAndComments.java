package com.katyat.variablesandcomments;

public class VariablesAndComments {
    public static void main(String[] args) {
//        am declarat o serie de tipurile variabele
        boolean falseBooleanVariable;
        boolean trueBooleanVariable;
        char firstChartFromAscii;
        char lastChartFromAscii;
...
//Initialization of the above variables
        ...
        firstChartFromAscii = 100;
        lastChartFromAscii = 'Z';
